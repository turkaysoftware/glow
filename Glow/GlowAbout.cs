            ...
            try{
                ...
                foreach (Control ui_buttons in PanelTxt.Controls){
                    if (ui_buttons is Button about_button){
                        ...
                        about_button.BackColor = TS_ThemeEngine.ColorMode(Glow.theme, "AccentMain");
                        about_button.FlatAppearance.BorderColor = TS_ThemeEngine.ColorMode(Glow.theme, "AccentMain");
                        about_button.FlatAppearance.MouseDownBackColor = TS_ThemeEngine.ColorMode(Glow.theme, "AccentMain");
                        about_button.FlatAppearance.MouseOverBackColor = TS_ThemeEngine.ColorMode(Glow.theme, "AccentMainHover");
                    }
                }
                //
                TSImageRenderer(About_WebsiteBtn, Glow.theme == 1 ? Properties.Resources.ct_website_light : Properties.Resources.ct_website_dark, 15, ContentAlignment.MiddleRight);
                TSImageRenderer(About_XBtn, Glow.theme == 1 ? Properties.Resources.ct_x_light : Properties.Resources.ct_x_dark, 15, ContentAlignment.MiddleRight);
                TSImageRenderer(About_InstagramBtn, Glow.theme == 1 ? Properties.Resources.ct_instagram_light : Properties.Resources.ct_instagram_dark, 15, ContentAlignment.MiddleRight);
                TSImageRenderer(About_GitHubBtn, Glow.theme == 1 ? Properties.Resources.ct_github_light : Properties.Resources.ct_github_dark, 15, ContentAlignment.MiddleRight);
                TSImageRenderer(About_YouTube, Glow.theme == 1 ? Properties.Resources.ct_youtube_light : Properties.Resources.ct_youtube_dark, 12, ContentAlignment.MiddleRight);
                //
                ...
                CloseAboutBtn.FlatAppearance.MouseOverBackColor = TS_ThemeEngine.ColorMode(Glow.theme, "TSBT_CloseBGHover");
                CloseAboutBtn.FlatAppearance.MouseDownBackColor = TS_ThemeEngine.ColorMode(Glow.theme, "TSBT_CloseBGHover");
                // ======================================================================================================
                // TEXTS
