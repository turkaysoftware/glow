        ...
        */
        ...
        public void login_system_preloader(){
            try{
                ...
                Text = string.Format(Encoding.UTF8.GetString(Encoding.Default.GetBytes(software_lang.TSReadLangs("TSPreloader", "tsbt_title").Trim())), Application.ProductName);
                load_text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(software_lang.TSReadLangs("TSPreloader", "tsbt_load").Trim()));
            }catch (Exception){ }
        }
    }
}