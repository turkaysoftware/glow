    ...
    public partial class GlowQuickAccessTool : Form{
        ...
        private void QB_About_Click(object sender, EventArgs e){
            try{
                ...
                MessageBox.Show(string.Format(Encoding.UTF8.GetString(Encoding.Default.GetBytes(software_lang.TSReadLangs("QuickAccessTool", "qat_launch_error").Trim())), ex.Message), Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
