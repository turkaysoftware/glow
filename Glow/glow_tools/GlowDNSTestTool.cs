    ...
    public partial class GlowDNSTestTool : Form{
        ...
        public void dns_test_settings(){
            try{
                ...
                DNS_TestStartBtn.ForeColor = Glow.ui_colors[19];
                DNS_CustomTestBtn.BackColor = Glow.ui_colors[8];
                DNS_CustomTestBtn.ForeColor = Glow.ui_colors[19];
                DNS_TestExportBtn.BackColor = Glow.ui_colors[8];
                DNS_TestExportBtn.ForeColor = Glow.ui_colors[19];
                //
                ...
                ping_time_text_error = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("DNSTestTool", "dtt_error").Trim()));
                DNS_TestStartBtn.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("DNSTestTool", "dtt_start").Trim()));
                DNS_CustomTestBtn.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("DNSTestTool", "dtt_custom").Trim()));
                DNS_TestExportBtn.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("DNSTestTool", "dtt_export").Trim()));
            }catch (Exception){ }
        }
        // LOAD
        // ======================================================================================================
        private void GlowDNSTestTool_Load(object sender, EventArgs e){
            dns_test_settings();
            try{
                DNS_Alternate_L2.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("DNSTestTool", "dtt_start_await").Trim()));
                DNS_Cloudflare_L2.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("DNSTestTool", "dtt_start_await").Trim()));
                DNS_Comodo_L2.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("DNSTestTool", "dtt_start_await").Trim()));
                DNS_ControlD_L2.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("DNSTestTool", "dtt_start_await").Trim()));
                DNS_DNSWatch_L2.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("DNSTestTool", "dtt_start_await").Trim()));
                DNS_Google_L2.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("DNSTestTool", "dtt_start_await").Trim()));
                DNS_LumenDNS_L2.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("DNSTestTool", "dtt_start_await").Trim()));
                DNS_OpenDNS_L2.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("DNSTestTool", "dtt_start_await").Trim()));
                DNS_Quad9_L2.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("DNSTestTool", "dtt_start_await").Trim()));
            }catch (Exception){ }
        }
        // ALTERATE
        // ======================================================================================================
        ...
        private void DNS_TestStartBtn_Click(object sender, EventArgs e){
            test_status = true;
            //
            Text = string.Format(Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("DNSTestTool", "dtt_title").Trim())), Application.ProductName) + " | " + Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("DNSTestTool", "dtt_title_test_ruining").Trim()));
            // Alternate DNS
        ...
        private void DNS_CustomTestBtn_Click(object sender, EventArgs e){
            try{
                string custom_ip = Interaction.InputBox(string.Format(Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("DNSTestTool", "dtt_custom_message").Trim())), "\n\n", cloudflare_dns_list[0]), string.Format(Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("DNSTestTool", "dtt_title").Trim())), Application.ProductName), "");
                if (custom_ip.Trim() != "" && custom_ip.Trim() != string.Empty){
                    if (IPAddress.TryParse(custom_ip.Trim(), out IPAddress ip)){
                        ...
                        DialogResult restart_custom_ip = MessageBox.Show(string.Format(Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("DNSTestTool", "dtt_custom_message_error").Trim())), "\n"), Application.ProductName, MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
        ...
        private void DNS_TestExportBtn_Click(object sender, EventArgs e){
            try{
                PrintDNSList.Add(Application.ProductName + " - " + string.Format(Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("PrintEngine", "pe_save_name").Trim())), Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("DNSTestTool", "dtt_export_name").Trim()))));
                ...
                // FOOTER
                PrintDNSList.Add(Application.ProductName + " " + Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("PrintEngine", "pe_version").Trim())) + " " + glow_version.GlowVersion(1, Glow.g_version_mode));
                PrintDNSList.Add($"(C) {DateTime.Now.Year} {Application.CompanyName}.");
                PrintDNSList.Add(Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("PrintEngine", "pe_process_time").Trim())) + " " + DateTime.Now.ToString("dd.MM.yyyy - HH:mm:ss"));
                PrintDNSList.Add(Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("PrintEngine", "pe_twitter").Trim())) + " " + TS_LinkSystem.twitter_link);
                PrintDNSList.Add(Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("PrintEngine", "pe_github").Trim())) + " " + TS_LinkSystem.github_link);
                //
                SaveFileDialog save_engine = new SaveFileDialog{
                    ...
                    DefaultExt = "txt",
                    FileName = Application.ProductName + " - " + string.Format(Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("PrintEngine", "pe_save_name").Trim())), Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("DNSTestTool", "dtt_export_name").Trim()))),
