    ...
    public partial class GlowDNSTestTool : Form{
        ...
        private void DNS_TestExportBtn_Click(object sender, EventArgs e){
            try{
                ...
                PrintDNSList.Add(Environment.NewLine + new string('-', 75) + Environment.NewLine);
                // FOOTER
                PrintDNSList.Add(Application.ProductName + " " + Encoding.UTF8.GetString(Encoding.Default.GetBytes(software_lang.TSReadLangs("PrintEngine", "pe_version").Trim())) + " " + glow_version.TS_SofwareVersion(1, Program.ts_version_mode));
