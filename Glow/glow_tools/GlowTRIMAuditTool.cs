    ...
    public partial class GlowTRIMAuditTool : Form{
        ...
        private void GlowTRIMAuditTool_Load(object sender, EventArgs e){
            ...
            try{
                ...
                tat_theme_settings();
                // TEXTS
                Text = string.Format(Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.GlowReadLangs("TRIMAuditTool", "tat_title").Trim())), Application.ProductName);
                TAT_L1.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.GlowReadLangs("TRIMAuditTool", "tat_status").Trim()));
                TAT_L3.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.GlowReadLangs("TRIMAuditTool", "tat_active_status").Trim()));
                TAT_L2.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.GlowReadLangs("TRIMAuditTool", "tat_check_waiting").Trim()));
                TAT_L4.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.GlowReadLangs("TRIMAuditTool", "tat_check_waiting").Trim()));
                TAT_CheckBtn.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.GlowReadLangs("TRIMAuditTool", "tat_check").Trim()));
                TAT_EnabledBtn.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.GlowReadLangs("TRIMAuditTool", "tat_activate").Trim()));
        ...
        // DYNAMIC THEME VOID
        // ======================================================================================================
        public void tat_theme_settings(){
            try{
                if (Glow.theme == 1){
                    ...
                    if (File.Exists(trim_check_name)){
                        ...
                        using (StreamReader trim_reader = new StreamReader(trim_check_name)){
                            ...
                            if (trim_check_list[0].Contains("0")){
                                TAT_L2.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.GlowReadLangs("TRIMAuditTool", "tat_on").Trim()));
                                TAT_L4.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.GlowReadLangs("TRIMAuditTool", "tat_trim_already_active").Trim()));
                            }else if (trim_check_list[0].Contains("1")){
                                TAT_L2.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.GlowReadLangs("TRIMAuditTool", "tat_off").Trim()));
                                // ENABLED
                                TAT_P3.Enabled = true;
                                TAT_P4.Enabled = true;
                            }else{
                                TAT_L2.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.GlowReadLangs("TRIMAuditTool", "tat_unknown").Trim()));
                            }
                    ...
                    if (File.Exists(trim_enabled_name)){
                        ...
                        using (StreamReader trim_reader = new StreamReader(trim_enabled_name)){
                            ...
                            if (trim_enabled_list[0].Contains("0")){
                                TAT_L4.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.GlowReadLangs("TRIMAuditTool", "tat_trim_enabled").Trim()));
                            }else if (trim_enabled_list[0].Contains("1")){
                                TAT_L4.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.GlowReadLangs("TRIMAuditTool", "tat_trim_not_enabled").Trim()));
                            }else{
                                TAT_L4.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.GlowReadLangs("TRIMAuditTool", "tat_trim_activate_to_error").Trim()));
                            }
