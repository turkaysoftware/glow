...
namespace Glow.glow_tools{
    public partial class GlowCacheCleanupTool : Form{
        ...
        private void GlowCacheCleanupTool_Load(object sender, EventArgs e){
            ...
            // LABEL PATH TEXT SET
            path_names.Add(Encoding.UTF8.GetString(Encoding.Default.GetBytes(software_lang.TSReadLangs("CacheCleanupTool", "cct_system_temp").Trim())));
            path_names.Add(Encoding.UTF8.GetString(Encoding.Default.GetBytes(software_lang.TSReadLangs("CacheCleanupTool", "cct_user_temp").Trim())));
        ...
        public void cct_theme_settings(){
            try{
                ...
                //
                CCT_L1.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(software_lang.TSReadLangs("CacheCleanupTool", "cct_system_temp").Trim()));
                CCT_L3.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(software_lang.TSReadLangs("CacheCleanupTool", "cct_user_temp").Trim()));
                // BTN TEXT
                CCT_CleanS_TempBtn.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(software_lang.TSReadLangs("CacheCleanupTool", "cct_clean").Trim()));
                CCT_CleanU_TempBtn.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(software_lang.TSReadLangs("CacheCleanupTool", "cct_clean").Trim()));
            }catch (Exception){ }
        }
        // ======================================================================================================
        // HOVER NAMES
        ...
        private void CCT_CleanS_TempBtn_Click(object sender, EventArgs e){
            try{
                TSGetLangs software_lang = new TSGetLangs(Glow.lang_path);
                DialogResult cct_check_delete_notifi = MessageBox.Show(string.Format(Encoding.UTF8.GetString(Encoding.Default.GetBytes(software_lang.TSReadLangs("CacheCleanupTool", "cct_check_delete_notification").Trim())), Encoding.UTF8.GetString(Encoding.Default.GetBytes(software_lang.TSReadLangs("CacheCleanupTool", "cct_system_temp").Trim())), clean_path_list[0], "\n\n"), cct_title, MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
        ...
        private void CCT_CleanU_TempBtn_Click(object sender, EventArgs e){
            try{
                TSGetLangs software_lang = new TSGetLangs(Glow.lang_path);
                DialogResult cct_check_delete_notifi = MessageBox.Show(string.Format(Encoding.UTF8.GetString(Encoding.Default.GetBytes(software_lang.TSReadLangs("CacheCleanupTool", "cct_check_delete_notification").Trim())), Encoding.UTF8.GetString(Encoding.Default.GetBytes(software_lang.TSReadLangs("CacheCleanupTool", "cct_user_temp").Trim())), clean_path_list[1], "\n\n"), cct_title, MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
                if (cct_check_delete_notifi == DialogResult.Yes){
