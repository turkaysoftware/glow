...
namespace Glow.glow_tools{
    public partial class GlowOverlay : Form{
        ...
        private void GlowOverlay_Load(object sender, EventArgs e){
            OVERLAY_CPU_V.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("ScreenOverlayTool", "sot_loading").Trim()));
            OVERLAY_RAM_V.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("ScreenOverlayTool", "sot_loading").Trim()));
            OVERLAY_DISK_V.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("ScreenOverlayTool", "sot_loading").Trim()));
            OVERLAY_NETWORK_V.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("ScreenOverlayTool", "sot_loading").Trim()));
            //
        ...
        public void screen_overlay_settings(){
            Text = string.Format(Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("ScreenOverlayTool", "sot_title").Trim())), Application.ProductName);
            OVERLAY_CPU.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("ScreenOverlayTool", "sot_cpu").Trim()));
            OVERLAY_RAM.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("ScreenOverlayTool", "sot_ram").Trim()));
            OVERLAY_DISK.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("ScreenOverlayTool", "sot_disk").Trim()));
            OVERLAY_NETWORK.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("ScreenOverlayTool", "sot_net").Trim()));
        }
        // ======================================================================================================
        // CPU ENGINE
            ...
            try{
                do{
                    ...
                    foreach (ManagementObject obj in searcher.Get()){
                        ...
                        OVERLAY_NETWORK_V.Text = string.Format("{0}\n{1}", string.Format("{0:0.00} Mbps", Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("ScreenOverlayTool", "sot_net_download").Trim())) + " " + mbpsReceived), string.Format("{0:0.00} Mbps", Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("ScreenOverlayTool", "sot_net_upload").Trim())) + " " + mbpsSent));
                    }
                    Thread.Sleep(750);
                }while (overlay_loop == true);
            }catch (Exception){ }
