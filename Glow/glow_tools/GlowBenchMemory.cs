    ...
    public partial class GlowBenchMemory : Form{
        ...
        public void Bench_ram_settings(){
            try{
                ...
                Bench_Panel.BackColor = TS_ThemeEngine.ColorMode(GlowMain.theme, "ContentPanelBGColor");
                //
                ...
                //
                Bench_TLP.BackgroundColor = TS_ThemeEngine.ColorMode(GlowMain.theme, "DataGridBGColor");
