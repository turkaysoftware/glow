    ...
    public partial class Glow : Form{
            ...
            try{
                ...
                using (Process get_ms_store_version = new Process()){
                    ...
                    if (!string.IsNullOrEmpty(get_ms_s_version)){
                        ...
                        OS_MSStoreVersion_V.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(software_lang.TSReadLangs("Os_Content", "os_c_unknown").Trim()));
                    }
                }
            }catch (Exception){ }
            try{
        ...
        private async void OS_BSoDZIP_Click(object sender, EventArgs e){
            ...
            try{
                ...
                // COPY ASYNC
                int currentFile = 0;
                Text = string.Format(Encoding.UTF8.GetString(Encoding.Default.GetBytes(software_lang.TSReadLangs("Os_Content", "os_c_bsod_progress_copy").Trim())), TS_SoftwareVersion.TS_SofwareVersion(0, Program.ts_version_mode));
                ...
                // ZIP ASYNC
                Text = string.Format(Encoding.UTF8.GetString(Encoding.Default.GetBytes(software_lang.TSReadLangs("Os_Content", "os_c_bsod_progress_compress").Trim())), TS_SoftwareVersion.TS_SofwareVersion(0, Program.ts_version_mode));
                await Task.Run(() => {
        ...
        private void lang_engine(string lang_type, string lang_code){
            try{
                ...
                OS_MSStoreVersion.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(software_lang.TSReadLangs("OperatingSystem", "os_ms_store_version").Trim()));
        ...
        private void print_engine_txt(){
            ...
            PrintEngineList.Add(new string('-', 60) + Environment.NewLine);
            // FOOTER
            PrintEngineList.Add(Application.ProductName + " " + Encoding.UTF8.GetString(Encoding.Default.GetBytes(software_lang.TSReadLangs("PrintEngine", "pe_version").Trim())) + " " + TS_SoftwareVersion.TS_SofwareVersion(1, Program.ts_version_mode));
        ...
        private void print_engine_html(){
            ...
            PrintEngineList.Add("\t\t\t<ul>");
            PrintEngineList.Add($"\t\t\t\t<li>{Application.ProductName + " " + Encoding.UTF8.GetString(Encoding.Default.GetBytes(software_lang.TSReadLangs("PrintEngine", "pe_version").Trim())) + " <span>" + TS_SoftwareVersion.TS_SofwareVersion(1, Program.ts_version_mode)}</span></li>");
