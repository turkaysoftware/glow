        ...
        */
            ...
            if (_lang_wrapper){
                switch (lang_mode){
                    case "en":
                        ...
                        break;
                    case "fr":
                        lang_engine(glow_lang_fr);
                        frenchToolStripMenuItem.Checked = true;
                        break;
                    case "de":
                        lang_engine(glow_lang_de);
                    ...
                    case "ko":
                        ...
                        break;
                    case "ru":
                        lang_engine(glow_lang_ru);
                        russianToolStripMenuItem.Checked = true;
                        break;
                    case "es":
                        lang_engine(glow_lang_es);
        ...
        private void OS_BSoDZIP_Click(object sender, EventArgs e){
            ...
            try{
                ...
                string minidump_zip_file = Application.StartupPath + @"\" + Application.ProductName + "_Minidump_" + Dns.GetHostName() + "_" + DateTime.Now.ToString("dd.MM.yyyy_HH.mm.ss") + ".zip";
        ...
        private void live_network_process(){
            try{
                ...
                foreach (ManagementObject obj in searcher.Get()){
                    string live_active_adapter = obj["Name"].ToString().Trim();
                    double live_aa_bw = Math.Round((ulong)obj["CurrentBandwidth"] / 1000000.0, 2);
                    NET_LT_Device_V.Text = string.Format(Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Network", "nk_live_speed_adapter_result").Trim())), live_active_adapter, live_aa_bw);
                }
                do{
                    foreach (ManagementObject obj in searcher.Get()){
                        ulong bytesReceived = (ulong)obj["BytesReceivedPerSec"];
                        ulong bytesSent = (ulong)obj["BytesSentPerSec"];
        ...
        private void gs_services(){
            ...
            try{
                ...
                foreach (ManagementObject query_service_rotate in search_service.Get()){
                    ...
                    string service_path_names = Convert.ToString(query_service_rotate["Name"]).Trim() + ".exe";
        ...
        private void color_mode(int ts){
            ...
            if (theme == 1){
                ...
                ui_colors.Add(Color.WhiteSmoke);                    // 9 - EMPTY
                ...
                PRINT_RotateBtn.Image = Properties.Resources.light_left_menu_export;
                ...
                screenOverlayToolStripMenuItem.Image = Properties.Resources.light_top_overlay;
                dNSTestToolStripMenuItem.Image = Properties.Resources.light_top_dns_test;
                ...
                ui_colors.Add(Color.FromArgb(31, 31, 31));          // 9 - EMPTY
                ...
                PRINT_RotateBtn.Image = Properties.Resources.dark_left_menu_export;
                // TOP MENU LOGO CHANGE
                ...
                screenOverlayToolStripMenuItem.Image = Properties.Resources.dark_top_overlay;
                dNSTestToolStripMenuItem.Image = Properties.Resources.dark_top_dns_test;
                ...
                ui_colors.Add(Color.FromArgb(46, 52, 64));          // 9 - EMPTY
                ...
                PRINT_RotateBtn.Image = Properties.Resources.nord_left_menu_export;
                // TOP MENU LOGO CHANGE
                ...
                screenOverlayToolStripMenuItem.Image = Properties.Resources.nord_top_overlay;
                dNSTestToolStripMenuItem.Image = Properties.Resources.nord_top_dns_test;
        ...
        private void glow_other_page_dynamic_ui(){
            ...
            try{
                ...
                string glow_tool_name = "screen_overlay_tool";
            ...
            try{
                ...
                string glow_tool_name = "dns_test_tool";
        ...
        private void theme_engine(){
            try{
                ...
                network_panel_4.BackColor = ui_colors[6];
                //
                ...
                EXPORT_Select.BackColor = ui_colors[10];
                ...
                EXPORT_StartEngineBtn.ForeColor = ui_colors[19];
                ...
                if (menu_btns == 1){
                    ...
                    PRINT_RotateBtn.BackColor = ui_colors[19];
                }
            }catch (Exception){ }
        }
                ...
                if (theme == 1){
                    switch (hi_value){
                        ...
                        case 12:
                            ...
                            break;
                        case 13:
                            HeaderImage.BackgroundImage = Properties.Resources.light_left_menu_export;
                            break;
                    }
                }else if (theme == 0){
                    switch (hi_value){
                        ...
                        case 12:
                            ...
                            break;
                        case 13:
                            HeaderImage.BackgroundImage = Properties.Resources.dark_left_menu_export;
                            break;
                    }
                }else if (theme == 2){
                    switch (hi_value){
                        ...
                        case 12:
                            ...
                            break;
                        case 13:
                            HeaderImage.BackgroundImage = Properties.Resources.nord_left_menu_export;
                            break;
                    }
                }
            }catch (Exception){ }
        ...
        private void PRINT_StartEngine_Click(object sender, EventArgs e){
            try{
                TSGetLangs g_lang = new TSGetLangs(lang_path);
        ...
        private void print_engine_progress_update(int status){
            try{
                ...
                switch (status){
                    case 1:
                        progress_page = OS_RotateBtn.Text.Trim();
                        break;
                    case 2:
                        progress_page = MB_RotateBtn.Text.Trim();
                        break;
                    case 3:
                        progress_page = CPU_RotateBtn.Text.Trim();
                        break;
                    case 4:
                        progress_page = RAM_RotateBtn.Text.Trim();
                        break;
                    case 5:
                        progress_page = GPU_RotateBtn.Text.Trim();
                        break;
                    case 6:
                        progress_page = DISK_RotateBtn.Text.Trim();
                        break;
                    case 7:
                        progress_page = NET_RotateBtn.Text.Trim();
                        break;
                    case 8:
                        progress_page = USB_RotateBtn.Text.Trim();
                        break;
                    case 9:
                        progress_page = SOUND_RotateBtn.Text.Trim();
                        break;
                    case 10:
                        progress_page = BATTERY_RotateBtn.Text.Trim();
                        break;
                    case 11:
                        progress_page = OSD_RotateBtn.Text.Trim();
                        break;
                    case 12:
                        progress_page = SERVICES_RotateBtn.Text.Trim();
                        break;
                }
                ...
                EXPORT_ProgressFEPanel.Width = (int)((EXPORT_ProgressBGPanel.Width * (status)) / 12);
            }catch (Exception){ }
        }
