        ...
        */
                    ...
                    if (get_langs_file > 0){
                        ...
                        try{
                            ...
                            if (en_lang_available == true){
                                ...
                                glow_prelaoder_alert(0);
                            }
                        }catch (Exception){ }
                    }else{
                        glow_prelaoder_alert(1);
                    }
                }else{
                    glow_prelaoder_alert(2);
                }
            }catch (Exception){ }
        }
        // ======================================================================================================
        // PRELOAD ALERT
        private void glow_prelaoder_alert(int pre_mode){
            ...
            foreach (ManagementObject query_os_rotate in search_os.Get()){
                try{
                    ...
                    if (hiding_mode_wrapper != 1){
                        ...
                        OS_SavedUser_V.Text = new string('*', vis_m_property.Next(vn_range[0], vn_range[1])) + $" ({Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("HeaderHidingMode", "header_hiding_mode_on_ui").Trim()))})";
                    }
                }catch (Exception){ }
                try{
                    // OS NAME
                ...
                try{
                    ...
                    if (os_device_id != "" && os_device_id != string.Empty){
                        ...
                        if (hiding_mode_wrapper != 1){
                            ...
                            OS_DeviceID_V.Text = new string('*', vis_m_property.Next(vn_range[0], vn_range[1])) + $" ({Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("HeaderHidingMode", "header_hiding_mode_on_ui").Trim()))})";
                        }
                    }else{
                ...
                try{
                    ...
                    if (hiding_mode_wrapper != 1){
                        ...
                        OS_Serial_V.Text = new string('*', vis_m_property.Next(vn_range[0], vn_range[1])) + $" ({Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("HeaderHidingMode", "header_hiding_mode_on_ui").Trim()))})";
                    }
                }catch (Exception){ }
                try{
            ...
            try{
                ...
                if (win_key != "null" && win_key != string.Empty){
                    if (hiding_mode_wrapper != 1){
                        ...
                        MainToolTip.SetToolTip(OS_WinKeyCopy, Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Os_Content", "os_c_license_copy_btn").Trim())));
                    }else{
                        OS_WinKeyCopy.Visible = false;
                        OS_WinKey_V.Text = new string('*', vis_m_property.Next(vn_range[0], vn_range[1])) + $" ({Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("HeaderHidingMode", "header_hiding_mode_on_ui").Trim()))})";
                    }
                }else{
                    OS_WinKeyCopy.Visible = false;
                    OS_WinKey_V.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Os_Content", "os_c_license_null").Trim()));
                }
            }catch (Exception){ }
            try{
                    ...
                    if (registryKey != null){
                        ...
                        if (releaseKey != null){
                            ...
                            if (releaseKeyValue >= 533320){
                                ...
                                OS_NETFrameworkVersion_V.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Os_Content", "os_c_net_framework_null").Trim()));
                            }
                        }else{
                            OS_NETFrameworkVersion_V.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Os_Content", "os_c_net_framework_null").Trim()));
                        }
                    ...
                    if (get_wallpaper != "" && get_wallpaper != string.Empty){
                        ...
                        if (File.Exists(get_wallpaper)){
                            ...
                            if (hiding_mode_wrapper != 1){
                                ...
                                OS_Wallpaper_V.Text = new string('*', vis_m_property.Next(vn_range[0], vn_range[1])) + Path.GetExtension(get_wallpaper) + " - " + wp_resoulation + " - " + TS_FormatSize(wallpaper_size_x64) + $" ({Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("HeaderHidingMode", "header_hiding_mode_on_ui").Trim()))})";
                            }
                            ...
                            if (hiding_mode_wrapper != 1){
                                ...
                                MainToolTip.SetToolTip(OS_WallpaperOpen, string.Format(Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Os_Content", "os_c_open_wallpaper").Trim())), new string('*', vis_m_property.Next(vn_range[0], vn_range[1])) + Path.GetExtension(wp_rotate)));
                            }
                        }else{
        ...
        private void OS_WinKeyCopy_Click(object sender, EventArgs e){
            try{
                ...
                TSGetLangs g_lang = new TSGetLangs(lang_path);
                MessageBox.Show(Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Os_Content", "os_c_license_copy").Trim())), Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Information);
            }catch (Exception){ }
        }
        ...
        private async void OS_BSoDZIP_Click(object sender, EventArgs e){
            ...
            try{
                ...
                int currentFile = 0;
                Text = string.Format(Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Os_Content", "os_c_bsod_progress_copy").Trim())), glow_version.GlowVersion(0, g_version_mode));
                ...
                // ZIP ASYNC
                Text = string.Format(Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Os_Content", "os_c_bsod_progress_compress").Trim())), glow_version.GlowVersion(0, g_version_mode));
                await Task.Run(() => {
            ...
            foreach (ManagementObject query_bb_rotate in search_bb.Get()){
                ...
                try{
                    ...
                    if (hiding_mode_wrapper != 1){
                        ...
                        MB_MotherBoardSerial_V.Text = new string('*', vis_m_property.Next(vn_range[0], vn_range[1])) + $" ({Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("HeaderHidingMode", "header_hiding_mode_on_ui").Trim()))})";
                    }
                }catch (Exception){ }
                try{
                    // MB VERSION
                ...
                try{
                    ...
                    if (system_family_check != "default string" && system_family_check == "to be filled by o.e.m."){
                        if (hiding_mode_wrapper != 1){
                            ...
                            MB_SystemFamily_V.Text = new string('*', vis_m_property.Next(vn_range[0], vn_range[1])) + $" ({Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("HeaderHidingMode", "header_hiding_mode_on_ui").Trim()))})";
                        }
                    }else{
                ...
                try{
                    ...
                    if (system_sku_check != "default string" && system_sku_check != "sku"){
                        if (hiding_mode_wrapper != 1){
                            ...
                            MB_SystemSKU_V.Text = new string('*', vis_m_property.Next(vn_range[0], vn_range[1])) + $" ({Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("HeaderHidingMode", "header_hiding_mode_on_ui").Trim()))})";
                        }
                    }else{
                ...
                try{
                    ...
                    if (tpm_man_id != "" || tpm_man_id != string.Empty){
                        if (hiding_mode_wrapper != 1){
                            ...
                            MB_TPMManID_V.Text = new string('*', vis_m_property.Next(vn_range[0], vn_range[1])) + $" ({Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("HeaderHidingMode", "header_hiding_mode_on_ui").Trim()))})";
                        }
                    }else{
            ...
            foreach (ManagementObject query_process_rotate in search_process.Get()){
                ...
                try{
                    ...
                    if (hiding_mode_wrapper != 1){
                        ...
                        CPU_SerialName_V.Text = new string('*', vis_m_property.Next(vn_range[0], vn_range[1])) + $" ({Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("HeaderHidingMode", "header_hiding_mode_on_ui").Trim()))})";
                    }
                }catch (Exception){ }
            }
        ...
        private void ram(){
            ...
            foreach (ManagementObject queryObj in search_pm.Get()){
                ...
                try{
                    ...
                    if (ram_windows_mode == 1){
                        ram_frekans_list.Add(ram_speed + " MT/s");
                    }else{
                        ram_frekans_list.Add(ram_speed + " MHz");
                    }
                ...
                try{
                    ...
                    if (ram_serial == "" || ram_serial == "Unknown" || ram_serial == "unknown" || ram_serial == string.Empty){
                        ...
                        if (hiding_mode_wrapper != 1){
                            ...
                            ram_serial_list.Add(new string('*', vis_m_property.Next(vn_range[0], vn_range[1])) + $" ({Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("HeaderHidingMode", "header_hiding_mode_on_ui").Trim()))})");
                        }
                    }
            ...
            try{
                ...
                for (int rs = 0; rs <= ram_amount; rs++){
                    RAM_SelectList.Items.Add(string.Format("{0} #{1} - {2} / {3}", Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Ram_Content", "ram_c_ram_slot_select").Trim())), (rs + 1), ram_manufacturer_list[rs], ram_amount_list[rs]));
                }
                            ...
                            try{
                                ...
                                if (disk_serial_number != "" || disk_serial_number != string.Empty){
                                    if (hiding_mode_wrapper != 1){
                                        ...
                                        disk_serial_list.Add(new string('*', vis_m_property.Next(vn_range[0], vn_range[1])) + $" ({Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("HeaderHidingMode", "header_hiding_mode_on_ui").Trim()))})");
                                    }
                                }else{
                            ...
                            try{
                                ...
                                if (disk_volume_serial_number != "" || disk_volume_serial_number != string.Empty){
                                    if (hiding_mode_wrapper != 1){
                                        ...
                                        disk_volume_serial_list.Add(new string('*', vis_m_property.Next(vn_range[0], vn_range[1])) + $" ({Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("HeaderHidingMode", "header_hiding_mode_on_ui").Trim()))})");
                                    }
                                }else{
        ...
        private void disk_bg_process(){
            ...
            try{
                ...
                if (!diskEntry.Equals(default(KeyValuePair<string, (ulong readSpeed, ulong writeSpeed)>))){
                    ...
                    Invoke(new Action(() =>{
                        DISK_Speed_V.Text = string.Format("{0} {1} / {2} {3}", $"{diskReadSpeedMB:F1} MB/s", Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("StorageContent", "se_c_speed_read").Trim())), $"{diskWriteSpeedMB:F1} MB/s", Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("StorageContent", "se_c_speed_write").Trim())));
                    }));
                }else{
                    Invoke(new Action(() =>{
                        DISK_Speed_V.Text = string.Format(Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("StorageContent", "se_c_speed_error").Trim())), currentDiskMode);
                    }));
                }
            }catch (Exception){
                //Invoke(new Action(() =>{
        ...
        private void network(){
                ...
                try{
                    ...
                    if (mac_adress == ""){
                        ...
                        if (hiding_mode_wrapper != 1){
                            ...
                            network_mac_adress_list.Add(new string('*', vis_m_property.Next(vn_range[0], vn_range[1])) + $" ({Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("HeaderHidingMode", "header_hiding_mode_on_ui").Trim()))})");
                        }
                    }
                ...
                try{
                    ...
                    if (guid == ""){
                        ...
                        if (hiding_mode_wrapper != 1){
                            ...
                            network_guid_list.Add(new string('*', vis_m_property.Next(vn_range[0], vn_range[1])) + $" ({Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("HeaderHidingMode", "header_hiding_mode_on_ui").Trim()))})");
                        }
                    }
                ...
                try{
                    ...
                    foreach (ManagementObject search_ip in query_na_ip.Get()){
                        if (search_ip["IPAddress"] == null){
                            network_ipv4_list.Add(Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Network_Content", "nk_c_unknown").Trim())));
                            network_ipv6_list.Add(Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Network_Content", "nk_c_unknown").Trim())));
                        }else{
            ...
            try{
                ...
                if (dns1 != "" && dns1 != string.Empty){
                    ...
                    NET_DNS1_V.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Network_Content", "nk_c_dns_not").Trim()));
                }
                if (dns2 != "" && dns2 != string.Empty){
                    NET_DNS2_V.Text = dns2;
                }else{
                    NET_DNS2_V.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Network_Content", "nk_c_dns_not").Trim()));
                }
            }catch (Exception){ }
            // NETWORK SELECT
            try{
                ...
                if (OSD_DataMainTable.Rows.Count > 0){
                    for (int i = 0; i<= OSD_DataMainTable.Rows.Count - 1; i++){
                        ...
                        if (OSD_DataMainTable.Rows[i].Cells[5].Value == null || (string)OSD_DataMainTable.Rows[i].Cells[5].Value == "" || (string)OSD_DataMainTable.Rows[i].Cells[5].Value == string.Empty){
                            OSD_DataMainTable.Rows[i].Cells[5].Value = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Osd_Content", "osd_c_unknown").Trim()));
                        }
                    }
                }
            }catch (Exception){ }
                ...
                if (SERVICE_DataMainTable.Rows.Count > 0){
                    for (int i = 0; i <= SERVICE_DataMainTable.Rows.Count - 1; i++){
                        ...
                        if (SERVICE_DataMainTable.Rows[i].Cells[5].Value == null || (string)SERVICE_DataMainTable.Rows[i].Cells[5].Value == "" || (string)SERVICE_DataMainTable.Rows[i].Cells[5].Value == string.Empty){
                            SERVICE_DataMainTable.Rows[i].Cells[5].Value = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Services_Content", "ss_c_unknown").Trim()));
                        }
                    }
                }
            }catch (Exception){ }
                ...
                switch (target_menu){
                    ...
                    case 13:
                        if (menu_btns != 13){
                            ...
                            HeaderText.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Header", "header_export").Trim()));
                        }
                        break;
                }
        ...
        private void lang_engine(string lang_type, string lang_code){
            try{
                ...
                chineseToolStripMenuItem.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("HeaderLangs", "lang_zh").Trim()));
                ...
                frenchToolStripMenuItem.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("HeaderLangs", "lang_fr").Trim()));
                germanToolStripMenuItem.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("HeaderLangs", "lang_de").Trim()));
                ...
                portugueseToolStripMenuItem.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("HeaderLangs", "lang_pt").Trim()));
                russianToolStripMenuItem.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("HeaderLangs", "lang_ru").Trim()));
                spanishToolStripMenuItem.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("HeaderLangs", "lang_es").Trim()));
                ...
                benchRAMToolStripMenuItem.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("HeaderTools", "ht_bench_ram").Trim()));
                ...
                screenOverlayToolStripMenuItem.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("HeaderTools", "ht_overlay").Trim()));
                dNSTestToolStripMenuItem.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("HeaderTools", "ht_dns_test_tool").Trim()));
                quickAccessToolStripMenuItem.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("HeaderTools", "ht_quick_access_tool").Trim()));
                ...
                PRINT_RotateBtn.Text = " " + " " + Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("LeftMenu", "left_export").Trim()));
                // OS
                ...
                OS_WinKey.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("OperatingSystem", "os_win_license_key").Trim()));
                OS_NETFrameworkVersion.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("OperatingSystem", "os_net_framework_version").Trim()));
                ...
                CPU_Usage.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Processor", "pr_cpu_usage").Trim()));
                ...
                GPU_CurrentColor.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Gpu", "gpu_current_color").Trim()));
                ...
                GPU_MonitorVirtualRes.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Gpu", "gpu_virtual_resolution").Trim()));
                ...
                GPU_ScreenBit.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Gpu", "gpu_monitor_bit_rate").Trim()));
                ...
                DISK_Speed.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Storage", "se_speed").Trim()));
                ...
                // NETWORK
                NET_LT_Device.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Network", "nk_live_speed_adapter").Trim()));
                NET_LT_DL1.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Network", "nk_live_speed_download").Trim()));
                NET_LT_UL1.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Network", "nk_live_speed_upload").Trim()));
                //
                ...
                NET_DNS1.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Network", "nk_dns1").Trim()));
                NET_DNS2.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Network", "nk_dns2").Trim()));
                // USB
                ...
                OSD_DataMainTable.Columns[1].HeaderText = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Osd", "osd_file_name").Trim()));
                OSD_DataMainTable.Columns[2].HeaderText = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Osd", "osd_driver_name").Trim()));
                OSD_DataMainTable.Columns[3].HeaderText = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Osd", "osd_driver_type").Trim()));
                OSD_DataMainTable.Columns[4].HeaderText = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Osd", "osd_start").Trim()));
                OSD_DataMainTable.Columns[5].HeaderText = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Osd", "osd_status").Trim()));
                ...
                SERVICE_DataMainTable.Columns[1].HeaderText = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Services", "ss_file_name").Trim()));
                SERVICE_DataMainTable.Columns[2].HeaderText = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Services", "ss_service_name").Trim()));
                SERVICE_DataMainTable.Columns[3].HeaderText = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Services", "ss_service_type").Trim()));
                SERVICE_DataMainTable.Columns[4].HeaderText = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Services", "ss_start").Trim()));
                SERVICE_DataMainTable.Columns[5].HeaderText = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Services", "ss_status").Trim()));
                ...
                // EXPORT
                EXPORT_HeaderLabel.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Export", "e_mode_title").Trim()));
                EXPORT_StartEngineBtn.Text = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Export", "e_mode_report_start").Trim()));
        ...
        private void color_mode(int ts){
            ...
            if (theme == 1){
                ...
                OS_RotateBtn.Image = Properties.Resources.lm_os_light;
                ...
                // LEFT MENU LOGO CHANGE
                OS_RotateBtn.Image = Properties.Resources.lm_os_dark;
        ...
        private void header_image_reloader(int hi_value){
            try{
                if (theme == 1){
                    switch (hi_value){
                        case 1:
                            HeaderImage.Image = Properties.Resources.lm_os_light;
                            break;
                        case 2:
                    ...
                    switch (hi_value){
                        case 1:
                            HeaderImage.Image = Properties.Resources.lm_os_dark;
                            break;
                        case 2:
        ...
        private void print_mode_add(){
            try{
                TSGetLangs g_lang = new TSGetLangs(lang_path);
                EXPORT_Select.Items.Add(Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Export", "e_mode_txt").Trim())));
                EXPORT_Select.Items.Add(Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Export", "e_mode_html").Trim())));
        ...
        private void EXPORT_StartEngineBtn_Click(object sender, EventArgs e){
            try{
                TSGetLangs g_lang = new TSGetLangs(lang_path);
                DialogResult start_print_info = MessageBox.Show(string.Format(Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Export", "e_mode_report_start_info").Trim())), EXPORT_Select.SelectedItem.ToString(), "\n\n"), Application.ProductName, MessageBoxButtons.YesNo, MessageBoxIcon.Information);
        ...
        private void print_engine_progress_update(int status){
            try{
                ...
                switch (status){
                    case 1:
                        progress_page = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("LeftMenu", "left_os").Trim()));
                        break;
                    case 2:
                        progress_page = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("LeftMenu", "left_mb").Trim()));
                        break;
                    case 3:
                        progress_page = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("LeftMenu", "left_cpu").Trim()));
                        break;
                    case 4:
                        progress_page = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("LeftMenu", "left_ram").Trim()));
                        break;
                    case 5:
                        progress_page = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("LeftMenu", "left_gpu").Trim()));
                        break;
                    case 6:
                        progress_page = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("LeftMenu", "left_storage").Trim()));
                        break;
                    case 7:
                        progress_page = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("LeftMenu", "left_network").Trim()));
                        break;
                    case 8:
                        progress_page = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("LeftMenu", "left_usb").Trim()));
                        break;
                    case 9:
                        progress_page = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("LeftMenu", "left_sound").Trim()));
                        break;
                    case 10:
                        progress_page = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("LeftMenu", "left_battery").Trim()));
                        break;
                    case 11:
                        progress_page = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("LeftMenu", "left_installed_drivers").Trim()));
                        break;
                    case 12:
                        progress_page = Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("LeftMenu", "left_installed_services").Trim()));
                        break;
                }
                if (status <= total_page){
                    EXPORT_ProgessLabel.Text = string.Format(Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Export", "e_mode_process").Trim())), progress_page, $"{status}", $"{total_page}");
                    EXPORT_ProgressFEPanel.Width = (int)((EXPORT_ProgressBGPanel.Width * (status)) / total_page);
                }else{
                    EXPORT_ProgessLabel.Text = string.Format(Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Export", "e_mode_save_await").Trim())), $"{status - 1}", $"{total_page}");
        ...
        private void print_engine_txt(){
            ...
            try{
                ...
                for (int gpu_render = 1; gpu_render <= gpu_amount; gpu_render++){
                    ...
                    PrintEngineList.Add(Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Gpu_Content", "gpu_c_gpu_print").Trim())) + " " + GPU_Select.SelectedItem + Environment.NewLine);
            ...
            try{
                ...
                for (int disk_render = 1; disk_render <= disk_amount; disk_render++){
                    ...
                    PrintEngineList.Add(Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("StorageContent", "se_c_disk_print").Trim())) + " " + DISK_CaptionList.SelectedItem + Environment.NewLine);
            ...
            try{
                ...
                for (int net_render = 1; net_render <= net_amount; net_render++){
                    ...
                    PrintEngineList.Add(Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Network_Content", "nk_c_network_print").Trim())) + " " + NET_ListNetwork.SelectedItem + Environment.NewLine);
            ...
            try{
                ...
                for (int usb_con_render = 1; usb_con_render <= usb_con_amount; usb_con_render++){
                    ...
                    PrintEngineList.Add(Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Usb_Content", "usb_c_controller_print").Trim())) + " " + USB_ConList.SelectedItem + Environment.NewLine);
            ...
            try{
                ...
                for (int usb_render = 1; usb_render <= usb_amount; usb_render++){
                    ...
                    PrintEngineList.Add(Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Usb_Content", "usb_c_device_print").Trim())) + " " + USB_Select.SelectedItem + Environment.NewLine);
            ...
            try{
                ...
                for (int sound_render = 1; sound_render <= sound_amount; sound_render++){
                    ...
                    PrintEngineList.Add(Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Sound_Content", "sound_c_print").Trim())) + " " + SOUND_Select.SelectedItem + Environment.NewLine);
        ...
        private void print_engine_html(){
            ...
            try{
                ...
                for (int gpu_render = 1; gpu_render <= gpu_amount; gpu_render++){
                    GPU_Select.SelectedIndex = gpu_render - 1;
                    PrintEngineList.Add($"\t\t\t\t<h4><span>{Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Gpu_Content", "gpu_c_gpu_print").Trim())) + "</span><span>" + GPU_Select.SelectedItem}</span></h4>");
                    PrintEngineList.Add("\t\t\t<ul>");
            ...
            try{
                ...
                for (int disk_render = 1; disk_render <= disk_amount; disk_render++){
                    DISK_CaptionList.SelectedIndex = disk_render - 1;
                    PrintEngineList.Add($"\t\t\t\t<h4><span>{Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("StorageContent", "se_c_disk_print").Trim())) + "</span><span>" + DISK_CaptionList.SelectedItem}</span></h4>");
                    PrintEngineList.Add("\t\t\t<ul>");
            ...
            try{
                ...
                for (int net_render = 1; net_render <= net_amount; net_render++){
                    NET_ListNetwork.SelectedIndex = net_render - 1;
                    PrintEngineList.Add($"\t\t\t\t<h4><span>{Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Network_Content", "nk_c_network_print").Trim())) + "</span><span>" + NET_ListNetwork.SelectedItem}</span></h4>");
                    PrintEngineList.Add("\t\t\t<ul>");
            ...
            try{
                ...
                for (int usb_con_render = 1; usb_con_render <= usb_con_amount; usb_con_render++){
                    USB_ConList.SelectedIndex = usb_con_render - 1;
                    PrintEngineList.Add($"\t\t\t\t<h4><span>{Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Usb_Content", "usb_c_controller_print").Trim())) + "</span><span>" + USB_ConList.SelectedItem}</span></h4>");
                    PrintEngineList.Add("\t\t\t<ul>");
            ...
            try{
                ...
                for (int usb_render = 1; usb_render <= usb_amount; usb_render++){
                    USB_Select.SelectedIndex = usb_render - 1;
                    PrintEngineList.Add($"\t\t\t\t<h4><span>{Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Usb_Content", "usb_c_device_print").Trim())) + "</span><span>" + USB_Select.SelectedItem}</span></h4>");
                    PrintEngineList.Add("\t\t\t<ul>");
            ...
            try{
                ...
                for (int sound_render = 1; sound_render <= sound_amount; sound_render++){
                    SOUND_Select.SelectedIndex = sound_render - 1;
                    PrintEngineList.Add($"\t\t\t\t<h4><span>{Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("Sound_Content", "sound_c_print").Trim())) + "</span><span>" + SOUND_Select.SelectedItem}</span></h4>");
                    PrintEngineList.Add("\t\t\t<ul>");
        ...
        private void benchRAMToolStripMenuItem_Click(object sender, EventArgs e){
            try{
                ...
                if (Application.OpenForms[glow_tool_name] == null){
                    ...
                    Application.OpenForms[glow_tool_name].Activate();
                    MessageBox.Show(string.Format(Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("HeaderToolsInfo", "header_tool_info_notification").Trim())), Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("HeaderTools", "ht_bench_ram").Trim()))), Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }catch (Exception){ }
        ...
        private void screenOverlayToolStripMenuItem_Click(object sender, EventArgs e){
            try{
                ...
                if (Application.OpenForms[glow_tool_name] == null){
                    ...
                    Application.OpenForms[glow_tool_name].Activate();
                    MessageBox.Show(string.Format(Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("HeaderToolsInfo", "header_tool_info_notification").Trim())), Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("HeaderTools", "ht_overlay").Trim()))), Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }catch (Exception){ }
        }
        // ======================================================================================================
        ...
        private void dNSTestToolStripMenuItem_Click(object sender, EventArgs e){
            try{
                ...
                if (Application.OpenForms[glow_tool_name] == null){
                    ...
                    Application.OpenForms[glow_tool_name].Activate();
                    MessageBox.Show(string.Format(Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("HeaderToolsInfo", "header_tool_info_notification").Trim())), Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("HeaderTools", "ht_dns_test_tool").Trim()))), Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }catch (Exception){ }
        }
        // ======================================================================================================
        ...
        private void quickAccessToolStripMenuItem_Click(object sender, EventArgs e){
            try{
                ...
                if (Application.OpenForms[glow_tool_name] == null){
                    ...
                    Application.OpenForms[glow_tool_name].Activate();
                    MessageBox.Show(string.Format(Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("HeaderToolsInfo", "header_tool_info_notification").Trim())), Encoding.UTF8.GetString(Encoding.Default.GetBytes(g_lang.TSReadLangs("HeaderTools", "ht_quick_access_tool").Trim()))), Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }catch (Exception){ }
        }
        // ======================================================================================================
